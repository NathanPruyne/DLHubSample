...
model.set_title('Dendrite Segmentation Tomography UNet Model')
model.set_name('dendrite_tomography_unet')
...
model.set_abstract("A deep learning model, based on UNet, to detect dendrites in an X-ray tomography image")
...
with open('tomo7_model_metadata.json', 'w') as fp:
