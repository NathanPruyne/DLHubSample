...
def apply_model(path):
    ...
    for img_path in files:
        ...
        plt.imsave('dlhub_results/tomography_7/' + str(img_path.split('/')[-1]), outs[0], cmap='gray')

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Apply images to the tomography v7 model via DLHub")
